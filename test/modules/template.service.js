...
const defaultKabaneroTemplates = [
    {
        ...
        description: 'Eclipse MicroProfile on Open Liberty & OpenJ9 using Maven',
        language: 'java',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.java-microprofile.v0.2.11.templates.default.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
    ...
    },
    {
        ...
        description: 'LoopBack 4 API Framework for Node.js',
        language: 'nodejs',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.nodejs-loopback.v0.1.4.templates.scaffold.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
        source: 'Kabanero Collections',
    },
    ...
    },
    {
        ...
        description: 'Express web framework for Node.js',
        language: 'nodejs',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.nodejs-express.v0.2.5.templates.skaffold.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
        source: 'Kabanero Collections',
    },
    {
        ...
        description: 'Runtime for Node.js applications',
        language: 'nodejs',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.nodejs.v0.2.5.templates.simple.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
        source: 'Kabanero Collections',
    },
    {
        ...
        description: 'Spring Boot using OpenJ9 and Maven',
        language: 'java',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.java-spring-boot2.v0.3.9.templates.default.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
        source: 'Kabanero Collections',
    },
    {
        ...
        description: 'Spring Boot using OpenJ9 and Maven',
        language: 'java',
        url: 'https://github.com/kabanero-io/collections/releases/download/0.2.1/incubator.java-spring-boot2.v0.3.9.templates.kotlin.tar.gz',
        projectType: 'appsodyExtension',
        projectStyle: 'Appsody',
        source: 'Kabanero Collections',
    },
